...
export const wordList = {
  ...
  B1: {
    1: [
      { question: "Urlaubsformen", answer: "The types of holiday/vacation" },
      { question: "der Winterurlaub", answer: "the winter holiday/vacation" },
      { question: "das Skigebiet", answer: "the ski area/resort" },
      { question: "der (Ski-)Lift", answer: "the (ski) lift" },
      { question: "der Strandurlaub", answer: "the beach holiday/vacation" },
      { question: "die Küste", answer: "the coast" },
      { question: "der Sand (Sg.)", answer: "the sand (singular)" },
      { question: "die Strandpromenade", answer: "the beach promenade" },
      { question: "der Urlaubsgruß", answer: "the holiday/vacation greeting" },
      { question: "Urlaubsplanung", answer: "the holiday/vacation planning" },
      { question: "der Zeitpunkt (Sg.)", answer: "the point in time (singular)" },
      { question: "der Terminkalender", answer: "the appointment calendar/diary" },
      { question: "rechtzeitig", answer: "in time, early enough" },
      { question: "gründlich", answer: "thorough, careful" },
      { question: "buchen (ein schickes Hotel buchen)", answer: "to book (to book a chic hotel)" },
      { question: "sich entschließen, er entschließt, hat entschlossen", answer: "to decide, he decides, has decided" },
      { question: "die Halbpension (Sg.)", answer: "the half board (singular)" },
      { question: "die Vollpension (Sg.)", answer: "the full board (singular)" },
      { question: "höchstens", answer: "at most, maximum" },
      { question: "enthalten sein (Frühstück ist im Preis enthalten.)", answer: "to be included (Breakfast is included in the price.)" },
      { question: "der Kompromiss", answer: "the compromise" },
      { question: "meinetwegen", answer: "for all I care, fine by me, on my account" },
      { question: "dabei sein (Dann ist für jeden etwas dabei.)", answer: "to be included/there (Then there is something for everyone.)" },
      { question: "der Einfall (Das ist ein guter Einfall.)", answer: "the idea, notion (That is a good idea.)" },
      { question: "einpacken", answer: "to pack" },
      { question: "auspacken", answer: "to unpack" },
      { question: "der Mitarbeiter", answer: "the male colleague/employee" },
      { question: "die Mitarbeiterin", answer: "the female colleague/employee" },
      { question: "Unterkünfte", answer: "the accommodation" },
      { question: "das Ferienhaus", answer: "the holiday/vacation house" },
      { question: "das Wellnesshotel", answer: "the wellness hotel" },
      { question: "die Hütte", answer: "the hut, cabin" },
      { question: "die Badewanne", answer: "the bathtub" },
      { question: "im Freien übernachten", answer: "to sleep outdoors" },
      { question: "zelten", answer: "to camp" },
      { question: "aufbauen (das Zelt aufbauen)", answer: "to set up (to set up the tent)" },
      { question: "der Ausblick", answer: "the view" },
      { question: "die Aussicht", answer: "the view" },
      { question: "herrlich", answer: "wonderful, magnificent" },
      { question: "schick", answer: "chic, smart, stylish" },
      { question: "der Aufenthalt", answer: "the stay" },
      { question: "vorbei sein (Der Aufenthalt ist fast vorbei.)", answer: "to be over (The stay is almost over.)" },
      { question: "Reisen", answer: "the travelling, journeys, trips" },
      { question: "das Urlaubsziel", answer: "the holiday/vacation destination" },
      { question: "die Entfernung", answer: "the distance" },
      { question: "die Fahrtzeit", answer: "the travel time" },
      { question: "gegen (gegen acht Uhr)", answer: "about/around (around eight o'clock)" },
      { question: "der Hauptbahnhof", answer: "the main train station" },
      { question: "der ICE", answer: "the ICE (Intercity-Express train)" },
      { question: "der Kofferraum", answer: "the boot (of a car), trunk" },
      { question: "die Schifffahrt", answer: "the boat trip, cruise" },
      { question: "das Boot", answer: "the boat" },
      { question: "Urlaub in der Natur", answer: "the holiday/vacation in nature" },
      { question: "die Alm", answer: "the alpine pasture/meadow" },
      { question: "die Kuh", answer: "the cow" },
      { question: "der Wanderer", answer: "the hiker" },
      { question: "das Gebirge", answer: "the mountain range, mountains" },
      { question: "der Himmel (Sg.)", answer: "the sky, heaven (singular)" },
      { question: "die Wiese", answer: "the meadow" },
      { question: "die Traube", answer: "the grape" },
      { question: "reif", answer: "ripe, mature" },
      { question: "brennen, es brennt, hat gebrannt (Ein Feuer brennt.)", answer: "to burn, it burns, has burned (A fire is burning.)" },
      { question: "giftig", answer: "poisonous, toxic" },
      { question: "das Insekt", answer: "the insect" },
      { question: "der Schutz (Sg.) (einen Insektenschutz verwenden)", answer: "the protection (singular) (to use an insect repellent/protection)" },
      { question: "das Netz", answer: "the net" },
      { question: "die Einsamkeit (Sg.)", answer: "the loneliness, solitude (singular)" },
      { question: "einsam", answer: "lonely, solitary" },
      { question: "der Empfang (Sg.) (Das Handy hat keinen Empfang.)", answer: "the receipt (The mobile phone has no receipt.)" },
      { question: "weg sein (Die Stadt ist weit weg.)", answer: "to be away/gone (The city is far away.)" },
      { question: "das Heimweh (Sg.)", answer: "the homesickness (singular)" },
      { question: "sich erkälten", answer: "to catch a cold" },
      { question: "Urlaubsaktivitäten", answer: "the holiday/vacation activities" },
      { question: "das Abenteuer (ein Abenteuer erleben)", answer: "the adventure (to have/experience an adventure)" },
      { question: "das Erlebnis", answer: "the experience" },
      { question: "entspannend", answer: "relaxing" },
      { question: "angenehm", answer: "pleasant, comfortable" },
      { question: "sich erholen", answer: "to recover, to relax" },
      { question: "faulenzen", answer: "to be lazy, to lounge" },
      { question: "spazieren", answer: "to stroll, to walk" },
      { question: "der Pilz (Pilze sammeln)", answer: "the mushroom (to collect mushrooms)" },
      { question: "mitarbeiten", answer: "to cooperate, to work together/along" },
      { question: "vorbeikommen, er kommt vorbei, ist vorbeigekommen", answer: "to come by, to drop in, he comes by, has come by" },
      { question: "Stimmung (nicht nur) im Urlaub", answer: "the mood (not only) on holiday/vacation" },
      { question: "begeistert sein", answer: "to be enthusiastic/thrilled" },
      { question: "gut/schlecht gelaunt sein", answer: "to be in a good/bad mood" },
      { question: "zufrieden sein", answer: "to be satisfied/content" },
      { question: "genervt sein", answer: "to be annoyed/irritated" },
      { question: "enttäuscht sein", answer: "to be disappointed" },
      { question: "verzweifelt sein", answer: "to be desperate/frantic" },
      { question: "andere wichtige Wörter und Wendungen", answer: "other important words and phrases" },
      { question: "beinahe (Ich war beinahe drei Monate auf der Alm.)", answer: "almost, nearly (I was almost three months on the alpine pasture.)" },
      { question: "auf (Ohren auf!)", answer: "up, open (Ears open!)" },
      { question: "drüben", answer: "over there" },
      { question: "hierher", answer: "here (to this place)" },
      { question: "momentan", answer: "at the moment, currently" },
      { question: "eher (Auf der Alm ist es eher einsam.)", answer: "rather, sooner (It is rather lonely on the alpine pasture.)" },
      { question: "jedenfalls", answer: "in any case, at any rate" },
      { question: "ca. (= circa)", answer: "approx. (= approximately)" },
      { question: "falls (Falls ihr Lust habt, meldet euch.)", answer: "in case, if (In case you're interested/feel like it, get in touch.)" },
      { question: "offenbar (Offenbar hatten auch andere diese Idee.)", answer: "apparently, obviously (Apparently others also had this idea.)" },
      { question: "der Typ", answer: "the type, guy" },
      { question: "der Chat", answer: "the chat" },
      { question: "erfahren, er erfährt, hat erfahren", answer: "to find out, to experience, he finds out, has found out" },
      { question: "die Neuigkeit", answer: "the news, piece of news" },
      { question: "der Rückblick", answer: "the review, retrospect" },
      { question: "solche (Wir kennen solche Listen.)", answer: "such, suchlike (We know such lists.)" },
      { question: "tragen, er trägt, hat getragen", answer: "to carry, to wear, he carries/wears, has carried/worn" },
      { question: "vorne liegen (Berlin liegt in dieser Liste ganz vorne.)", answer: "to be at the front/head (Berlin is right at the top of this list.)" },
      { question: "wieso (Wieso fahren wir nicht an die Ostsee?)", answer: "why, how come (Why don't we drive to the Baltic Sea?)" },
      { question: "das Zeug (Sg.)", answer: "the stuff (singular)" },
      { question: "da (Da die Stadt sehr bekannt ist, gibt es viele Touristen.)", answer: "since, as (Since the city is very famous, there are many tourists.)" },
      { question: "obwohl (Obwohl es geregnet hat, waren wir gut gelaunt.)", answer: "although, though (Although it had rained, we were in a good mood.)" },
      { question: "zu (Ich habe keine Lust, lange nach einer Unterkunft zu suchen.)", answer: "to (I don't feel like searching for accommodation for a long time.)" },
      { question: "Wichtig für mich", answer: "Important for me" },
      { question: "Welches Verb passt? Ergänzen Sie.", answer: "Which verb fits? Complete." },
      { question: "das Zelt", answer: "the tent" },
      { question: "aufbauen", answer: "to set up" },
      { question: "ein Abenteuer", answer: "an adventure" },
      { question: "erleben", answer: "to experience" },
      { question: "Pilze", answer: "the mushroom" },
      { question: "sammeln", answer: "to collect" }
    ],
    2: [
      { question: "Geräte und Zubehör", answer: "Devices and Accessories" },
      { question: "der Staubsauger", answer: "the vacuum cleaner" },
      { question: "die Waschmaschine", answer: "the washing machine" },
      { question: "der Kopfhörer", answer: "the headphone" },
      { question: "die Powerbank", answer: "the power bank" },
      { question: "der USB-Stick", answer: "the USB stick" },
      { question: "der Knopf", answer: "the button" },
      { question: "die Taste", answer: "the key" },
      { question: "der Monitor", answer: "the monitor" },
      { question: "einschalten (den Monitor einschalten)", answer: "to switch on (to switch on the monitor)" },
      { question: "installieren", answer: "to install" },
      { question: "das Ladekabel", answer: "the charging cable" },
      { question: "anschließen, er schließt an, hat angeschlossen (ein Kabel anschließen)", answer: "to connect/to follow (he connects, has connected) (to connect a cable)" },
      { question: "der Handyakku", answer: "the mobile phone battery" },
      { question: "aufladen, er lädt auf, hat aufgeladen (den Akku aufladen)", answer: "to charge (he charges, has charged) (to charge the battery)" },
      { question: "laden, er lädt, hat geladen (das Handy laden)", answer: "to charge (he charges, has charged) (to charge the mobile phone)" },
      { question: "sparsam", answer: "economical/sparing/frugal" },
      { question: "stumm schalten (das Handy stumm schalten)", answer: "to mute (to mute the mobile phone)" },
      { question: "(sich) anschaffen (sich ein neues Handy anschaffen)", answer: "to buy/to get/to purchase (to buy oneself a new mobile phone)" },
      { question: "dabeihaben, er hat dabei, hat dabeigehabt", answer: "to have with one/to have along (he has with him, has had with him)" },
      { question: "Reparieren und reklamieren", answer: "Repair and complain" },
      { question: "reklamieren", answer: "to complain/to make a claim" },
      { question: "umtauschen", answer: "to exchange/to swap" },
      { question: "zurückgeben, er gibt zurück, hat zurückgegeben", answer: "to return/to give back (he returns, has returned)" },
      { question: "die Garantie", answer: "the guarantee" },
      { question: "die Quittung", answer: "the receipt" },
      { question: "kaputt gehen, er geht kaputt, ist kaputt gegangen", answer: "to break down/to get broken (it breaks down, has broken down)" },
      { question: "reparieren", answer: "to repair" },
      { question: "zufrieden", answer: "satisfied/content" },
      { question: "testen", answer: "to test" },
      { question: "benötigen", answer: "to need/to require" },
      { question: "die Anleitung", answer: "the instructions" },
      { question: "die Gebrauchsanweisung", answer: "the operating manual" },
      { question: "Smartes Wohnen", answer: "Smart Living" },
      { question: "automatisch", answer: "automatically/automatic" },
      { question: "bedienen (etwas von Hand bedienen)", answer: "to operate/to use/to avail oneself of (to operate something by hand)" },
      { question: "steuern", answer: "to control/to steer" },
      { question: "anpassen (an+A.)", answer: "to adapt/to adjust/to modify (to adapt to)" },
      { question: "berühren", answer: "to touch/to affect/to move" },
      { question: "reinigen", answer: "to clean/to purify" },
      { question: "technisch", answer: "technical" },
      { question: "die Technologie", answer: "the technology" },
      { question: "smart", answer: "smart/clever" },
      { question: "machen (zu+D.) (Die Wohnung zu einem Smart Home machen.)", answer: "to make (to make into) (To make the apartment into a Smart Home.)" },
      { question: "die Alarmanlage", answer: "the alarm system" },
      { question: "der Einbruch", answer: "the break-in" },
      { question: "die Gefahr", answer: "the danger" },
      { question: "sicher", answer: "safe/secure/certain" },
      { question: "der Neubau", answer: "the new building" },
      { question: "die Haustür", answer: "the front door" },
      { question: "der Fingerabdruck", answer: "the fingerprint" },
      { question: "der Sprachassistent", answer: "the voice assistant" },
      { question: "aufnehmen, nimmt auf, hat aufgenommen", answer: "to record/to take in/to take up (he records, has recorded)" },
      { question: "gleichzeitig", answer: "simultaneously/at the same time" },
      { question: "der Tagesablauf", answer: "the daily routine" },
      { question: "Werbung", answer: "Advertising" },
      { question: "das Produkt", answer: "the product" },
      { question: "auf den Markt kommen", answer: "to come onto the market/to enter the market" },
      { question: "das Kaufverhalten", answer: "the buying behavior" },
      { question: "das Verhalten", answer: "the behavior" },
      { question: "der Slogan", answer: "the slogan" },
      { question: "ansprechen, er spricht an, hat angesprochen (Werbung spricht Gefühle an.)", answer: "to address/to speak to/to appeal to/to contact (he addresses, has addressed) (Advertising appeals to feelings.)" },
      { question: "auffallen, er fällt auf, ist aufgefallen", answer: "to stand out/to be noticeable (he stands out, has stood out)" },
      { question: "wirken (auf + A.)", answer: "to act (on/upon)/to have an effect (on)" },
      { question: "wecken (Wünsche wecken)", answer: "to wake/to arouse/to awaken (to arouse wishes)" },
      { question: "beeinflussen", answer: "to influence/to affect" },
      { question: "der Rabatt", answer: "the discount" },
      { question: "das Sonderangebot", answer: "the special offer" },
      { question: "das Merkmal", answer: "the feature/the characteristic" },
      { question: "frech", answer: "cheeky/naughty/impudent" },
      { question: "ausgezeichnet", answer: "excellent/outstanding/perfect" },
      { question: "bemerken", answer: "to notice/to observe" },
      { question: "verbieten, er verbietet, hat verboten", answer: "to forbid/to prohibit (he forbids, has forbidden)" },
      { question: "vertrauen", answer: "to trust/to confide" },
      { question: "reichen (Das reicht schon.)", answer: "to be enough/to suffice/to be sufficient (That is enough already.)" },
      { question: "aufmerksam", answer: "attentive/careful/alert" },
      { question: "interessiert", answer: "interested" },
      { question: "die Erinnerung", answer: "the memory" },
      { question: "das Magazin", answer: "the magazine" },
      { question: "die Vorstellung", answer: "the idea/the notion/the introduction" },
      { question: "Geld und Banken", answer: "Money and Banks" },
      { question: "die EC-Karte", answer: "the EC card (debit card)" },
      { question: "die Geheimzahl", answer: "the PIN (Personal Identification Number)" },
      { question: "der Geldautomat", answer: "the ATM (Automated Teller Machine)" },
      { question: "das Girokonto", answer: "the current account/the checking account" },
      { question: "gratis", answer: "free of charge/gratis" },
      { question: "genügen", answer: "to be enough/to suffice" },
      { question: "sich lohnen (Das lohnt sich nicht.)", answer: "to be worthwhile/to be worth it (That is not worthwhile.)" },
      { question: "sich leisten", answer: "to afford (oneself)" },
      { question: "das Portemonnaie", answer: "the wallet/the purse" },
      { question: "Andere wichtige Wörter und Wendungen", answer: "Other important words and phrases" },
      { question: "an haben, er hat an, hat angehabt", answer: "to have on/to be wearing (he has on, has had on)" },
      { question: "die Ausnahme", answer: "the exception" },
      { question: "bereits", answer: "already/as early as" },
      { question: "bloß (Das kostet bloß 10 Euro).", answer: "only/merely (That costs only 10 Euros)." },
      { question: "diesmal", answer: "this time" },
      { question: "daher/darum/deswegen", answer: "therefore/that's why/consequently" },
      { question: "sodass", answer: "so that" },
      { question: "ebenfalls", answer: "likewise/also" },
      { question: "vor einer Frage stehen", answer: "to be faced with a question" },
      { question: "geschehen, es geschieht, ist geschehen", answer: "to happen/to occur (it happens, has happened)" },
      { question: "merkwürdig", answer: "strange/odd/peculiar" },
      { question: "seltsam", answer: "strange/odd/weird" },
      { question: "nähen", answer: "to sew" },
      { question: "rein (reines Glück)", answer: "pure/clean (pure luck)" },
      { question: "sich Sorgen machen", answer: "to worry/to be worried" },
      { question: "das Taschentuch", answer: "the handkerchief" },
      { question: "der Transport", answer: "the transport" },
      { question: "verraten, er verrät, hat verraten", answer: "to betray/to reveal/to disclose (he betrays, has betrayed)" },
      { question: "die Wand", answer: "the wall" },
      { question: "streichen, er streicht, hat gestrichen (eine Wand streichen)", answer: "to paint/to stroke/to cancel (he paints, has painted) (to paint a wall)" },
      { question: "wegen", answer: "because of/due to" },
      { question: "trotz", answer: "despite/in spite of" },
      { question: "Wichtig für mich", answer: "Important for me" },
      { question: "Welche Geräte benutzen Sie wann? Ergänzen Sie.", answer: "Which devices do you use when? Complete the list." },
      { question: "auf Reisen", answer: "on trips/when traveling " },
      { question: "zu Hause", answer: "at home " },
      { question: "beim Sport", answer: "while exercising/during sports " },
      { question: "in der Arbeit", answer: "at work " },
      { question: "die Powerbank", answer: "The power bank " },
      { question: "der Kopfhörer", answer: "The headphones " },
      { question: "das Ladekabel", answer: "The charging cable " },
      { question: "die Waschmaschine", answer: "The washing machine " },
      { question: "der Staubsauger", answer: "The vacuum cleaner " },
      { question: "die Alarmanlage", answer: "The alarm system" },
      ...
      { question: "der Monitor", answer: "The Monitor " },
      { question: "der USB-Stick", answer: "The USB stick " },
      { question: "Ein typischer Tag mit Ihren Geräten. Was machen Sie? Schreiben Sie sechs Sätze.", answer: "A typical day with your devices. What do you do? Write six sentences. " },
      { question: "Am Morgen schalte ich mein Handy ein.", answer: "In the morning, I switch on my mobile phone. " },
      { question: "Dann lade ich es mit dem Ladekabel auf, während ich frühstücke.", answer: "Then, I charge it with the charging cable while I eat breakfast. " },
      { question: "Auf dem Weg zur Arbeit höre ich Musik mit meinen Kopfhörern.", answer: "On the way to work, I listen to music with my headphones. " },
      { question: "Im Büro schließe ich meinen USB-Stick an den Monitor an, um meine Arbeit zu sehen.", answer: "At the office, I connect my USB stick to the monitor to view my work. " },
      { question: "Nach der Arbeit steuere ich die smarten Geräte zu Hause über eine App.", answer: "After work, I control the smart devices at home via an app. " },
      { question: "Bevor ich schlafen gehe, schalte ich das Licht im Wohnzimmer aus.", answer: "Before going to sleep, I switch off the light in the living room. " }
    ],
    3: [
    ],
    4: [
